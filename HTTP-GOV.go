...
func main() {
	...
	if version {
		fmt.Println("HTTP-LOAD", __version__)
		os.Exit(0)
	}
	...
	go func() {
		...
		fmt.Println("\u001B[31mIn use               \u001B[31m║\t\u001B[35m║\tATTACK OK ║\tATTACK Meluncur")
		for {
			...
			case targetComplete:
				...
				fmt.Println("\r🚀HTTP-LOAD ATTACK FINISHED🚀     \n\n\r")
				os.Exit(0)
			}
		}
	}()
